...
const bookModel = require('../models/books/pg/pg-book-model.js');
...
app.post('/searches', book.createSearch);
app.get('/searches/new', book.newSearch);
...
//*********************************** */
// Callback can change to call 404 MW
//*********************************** */
app.get('*', (request, response) => response.status(404).send('This route does not exist'));

let start = app.listen(PORT, () => console.log(`Postgres server listening on port: ${PORT}`));
